...
local function cliff_overlaps_tiles(cliff, tile_names)
    ...
    -- Cliffs span multiple tiles, so check their whole generated footprint rather than
    -- only the center position. This catches cliffs placed across biome borders.
...
if surface and surface.valid then
    for chunk in surface.get_chunks() do
        process_area(surface, chunk_to_area(chunk))
    end
end
